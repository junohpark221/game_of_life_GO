...
func writePgmImage(p golParams, i ioChans, d distributorChans) {
...
// Assess the world by using the variable finalWorld
...
func readPgmImage(p golParams, i ioChans, d distributorChans) {
	filename := <-i.distributor.filename
...
func pgmIo(p golParams, i ioChans, d distributorChans) {
	for {
		select {
